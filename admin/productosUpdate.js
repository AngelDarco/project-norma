document.addEventListener("DOMContentLoaded", () => {
  ...
  precio.addEventListener("blur", () => (precioCard.innerHTML = precio.value));
  stock.addEventListener("blur", () => (stockCard.innerHTML = stock.value));
  genero.addEventListener("blur", () => (generoCard.innerHTML = genero.value));
